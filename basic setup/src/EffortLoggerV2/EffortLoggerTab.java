...
import application.EffortConsoleController;
...
//            Scene mainScene = createTabPaneScene();
            EffortConsoleController controller = new EffortConsoleController(primaryStage, new ActivityPage(primaryStage).getActivityPageScene());
